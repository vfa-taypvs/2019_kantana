<?php
class AdminServiceRowTwoMaster extends MY_Controller{
  ...
  public function index(){
    ...
    $this->_data['services'] = $this->Madminservices->getAllServicesAtRow(2);
    $this->load->view('/admin/services_row2.php', $this->_data);
  }
  ...
  public function add () {
    ...
    if (isset ($_FILES['file'])) {
      ...
      $uploadfile = $_SERVER['DOCUMENT_ROOT'] . '/files/services/row2/'.$filename;
  ...
  public function delete () {
    ...
    $deleteFile = $_SERVER['DOCUMENT_ROOT'] . '/files/services/row2/'.$image;
