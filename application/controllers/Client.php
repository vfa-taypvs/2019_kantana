...
class Client extends CI_Controller{
  ...
  public function index(){
    $this->load->model("Muserclient");

    $this->_data['title'] = 'Clients';

    $this->_data['row1'] = $this->Muserclient->getClientsAtRow(1);
    $this->_data['row2'] = $this->Muserclient->getClientsAtRow(2);
    $this->_data['row3'] = $this->Muserclient->getClientsAtRow(3);
    $this->_data['row4'] = $this->Muserclient->getClientsAtRow(4);

    $this->load->view('/user/client.php', $this->_data);
  }
